...
+ *Proteins*
  ...
  + Modefied penicillin bidning proteins in MRSA
...
+ *Virulnce factors*
  + urease producer
  + biofilm formation
    + Facilitates colonization of surfaces of prosthetic devices
**** Diseases :
...
+ UTIs
**** Treatment
+ TMP/SMX or 1st generation cephasporin(e.g cephalexin)
<<<<<<< HEAD
=======
...
|-----------+-------------------------------------+--------------------------+--------------|
>>>>>>> 3220595 (Add streptococcus, 33,34)
